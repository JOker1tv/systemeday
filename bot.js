...
client.on("294903578349535232","id" => {
...
client.on("guildMemberAdd", member => {
  client.channels.find('id', '643982460371337247').send(` **Welcome To .. Server**  `)
});
/////////
...
/////
client.login('NjQ1NzQwNDY4MzY5NjIwOTk5.XdKzgA.S76bN2qWQJnr8Mm8YboiEEl0zZg');
